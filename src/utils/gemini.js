...
export async function testGeminiConnection(accessToken) {
  ...
  try {
    ...
    throw new Error(`Failed to connect to Vertex AI: ${error.message}`);
  }
}

// Note: gradeWorksheet is handled in background.js to keep the heavy lifting off the UI thread
// and to centralize the logic. This file is kept for testing and potential future client-side usage.
